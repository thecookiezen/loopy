...
AgentBuilder.named("data-pipeline")
        .action("fetch-raw")
            ...
            .cost(0.3)
            .behavior(ctx -> ActionResult.Success.of(fetchRaw(ctx)))
            .add()
        .action("validate")
            .input(RawData.class)
            ...
            .cost(0.2)
            .behavior(ctx -> ActionResult.Success.of(validate(ctx)))
            .add()
        .action("export")
            ...
            .cost(0.1)
            .behavior(ctx -> ActionResult.Success.of(export(ctx)))
            .add()
...
AgentBuilder.named("review-agent")
        .action("approve")
            ...
            .cost(0.2)
            .behavior(ctx -> ActionResult.Success.of(approve(ctx)))
            .add()
...
AgentBuilder.named("resilient-agent")
        ...
        .action("call-api")
            .behavior(ctx -> callExternalApi(ctx))
            .add()
        .action("fallback")
            .behavior(ctx -> useCachedData(ctx))
            .add()
        .goal("data-retrieved")
